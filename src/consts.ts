...
export const DEFAULT_SITE_PROFILE = {
  siteTitle: "Barti's",
  displayName: "Oscar Bartolome Valdez Sarubbi",
  schemaName: "Oscar Bartolome Valdez Sarubbi",
  summary:
  ...
  linkedinUrl: "https://www.linkedin.com/in/oscar-bartolome-valdez-sarubbi-80a3a5168/",
  githubUrl: "https://github.com/bartivs",
  resumeUrl: "https://resume.barticode.com/english",
...
export const DEFAULT_HOME_PAGE = {
  ...
  heroTitle: "Oscar Bartolome Valdez Sarubbi — AI-Driven FullStack Engineer",
  heroBody:
...
export const DEFAULT_ABOUT_PAGE = {
  seoTitle: "Oscar Bartolome Valdez Sarubbi — AI Engineer | RAG, LLM, Cloud-Native",
  seoDescription: DEFAULT_SITE_PROFILE.summary,
};
